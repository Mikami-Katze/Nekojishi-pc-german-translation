...
translate german day2_01_tig_e823d87d:
    ...
    b "Es ist so schwer... Irgendetwas drückt sich auf jeden Fall an mich, dass ich an der ganzen Masse ersticke. I versuche mich frei zu kämpfen, aber es ist zwecklos. "
...
translate german day2_01_tig_43214818:
    ...
    b "Ich kann nicht mal meine Arme bewegen oder meine Füße. Ich kann mich nicht mal bemühen mich umzudrehen."
    b "Eine kalte Brise trifft auf mein Gesicht, aber es hilft nichts bei dieser Wärme. Was ist hier los? Ich atme tief ein und öffne meine Augen. "
    b ""

# game/script/03_day2.rpy:14
translate german day2_01_tig_8b8ad312:

    # b "In front of my face I see a large shadow. I blink hard, trying to make out it's form... A wall of muscle covered with soft, fluffy, orange fur. It looks so nice. I mean... {w=0.5}If it's not trying to kill me. "
    b "Da ist ein großer Schatten vor meinem Gesicht. Ich blinzel stark and bemerke, dass es eine Wand aus Muskeln ist, umgeben von einem flauschigem, orangenem Fell. Es sieht schön aus. Ich meine... {w=0.5}Wenn es nur nicht versuchen würde mich umzubringen. "
...
translate german day2_01_tig_af30e230:
    ...
    b "Endlich, er lässt mich weiterleben, indem er von meinem Bett aufsteht. Ich dachte ich wäre dabei zu sterben! "
    b "Zu Tode zerdrückt zu werden vom eigenen Wächtertiger ist eine ziemlich bescheurter Art es zu tun, also... "
...
translate german day2_01_tig_c71df00e:
    ...
    # lpdcat confused "\"Ten? That's early... {w=0.5}I'm going back to sleep...\" "
...
translate german day2_01_lpd_3c62f9b0:
    ...
    # avt "\"I mean... {w=0.5}I can't exactly throw my Senpai out while he's asleep. I know, it's a lot of trouble to go though but it's what I have to do.\" "
...
translate german day2_01_lpdcat_b047e199:
    ...
    # b "What the hell? I can see pieces of golden, {w=0.5}tasty... {w=0.5}salt & pepper chicken?"
    b ""

# game/script/03_day2.rpy:283
translate german day2_01_lpdcat_e430100c:

    # b "Those fried basils look so appetizing. Mmmm— five pieces of chicken? {w=0.5}Man, I'm feeling hungry...\" "
    b ""
...
translate german day2_01_lpdcat_2e99f1f5:
    ...
    # b "Then theres Senpai curled up under my quilt, his fluffy little head poking out of the \nend. "
    b ""
...
translate german day2_01_lpdcat_968c7ece:
    ...
    # b "So Tiger really is bothered about that... {w=0.5}There's not really much I can do since I already let Senpai use the bed. "
    b ""
...
translate german day2_01_lpdcat_ea9ef7c4:
    ...
    # b "Tiger points to my phone on the bedside table... {w=0.5}It's already ten. I usually get up around nine. "
    b ""
...
translate german day2_02_506f66e6:
    ...
    # b "I decide to just use my computer to pass the time. Turning it on and opening up my social media pages... {w=0.5}Wait, something feels strange. "
    b ""
...
translate german day2_02_61d8e4e2:
    ...
    # avt "\"...Could you stop, please? I-{w=0.5}It makes me uncomfortable.\" "
    avt ""
...
translate german day2_02_e3d4dfb9:
    ...
    # avt "\"I mean... {w=0.5}It's strange to have someone watching you.\" "
    avt ""
...
translate german day2_02_772c8ebb:
    ...
    # b "The book is simultaneously still on the shelf {i}and{/i} \ in his hand... {w=0.5}How did he do that? "
    b ""
...
translate german day2_02_7ea62281:
    ...
    # b "He doesn't really care does he... {w=0.5}People say the further you get in college the less you care about it. Surely the code of honor my senpai lives by. "
    b ""
...
translate german day2_02_2670da57:
    ...
    # b "\"Senpai walks out from the bathroom, wiping his face dry with my towel. {w=0.5}\nYes, my towel.\" "
    b ""
...
translate german day2_02_cdb91bb9:
    ...
    # avt "\"It's time for me to go. I'm counting on you two look after the house while I'm gone Tiger.\" "
    avt ""
...
translate german day2_02_4494c6df:
    ...
    # avt "\"Uh, alright... {w=0.5}What do you want?\" "
    avt ""
...
translate german day2_02_b51ad4af:
    ...
    # lpdcat normal "\"I just thought... {w=0.5}Um... {w=0.5}Alright! You better keep your word!\" "
    lpdcat normal ""
...
translate german day2_02_fc90fdc1:
    ...
    # avt "\"I thought the he wanted to eat a burger though. It's not like I need to eat anything.\" "
    avt ""
...
translate german day2_02_99ff5083:
    ...
    # avt "\"What? {w=0.5}No, wait. {w=0.5}So what do you mean by he {i}doesn't{/i} \ eat things?\" "
    avt ""
...
translate german day2_02_6eb17c5d:
    ...
    # avt "\"So... {w=0.5}It's more like an offering?\" "
    avt ""
...
translate german day2_02_a7316378:
    ...
    # avt "\"Okay... {w=0.5}So this 'Chi' you mentioned. Is that something gods need?\" "
    avt ""
...
translate german day2_02_50681b67:
    ...
    # b "\"So all this time I've been serving my guardian tiger? But by that logic... {w=0.5}I've done... {w=0.5}embarrassing things in the temple. Is that even okay?\" "
    b ""
...
translate german day2_02_69f2966d:
    ...
    # b "Our dance club in a place we call {i}the mirror wall{/i}. It's basically an open veranda room with the back wall covered in mirrors. "
...
translate german day2_03_lpdcat_c9004785:
    ...
    # lpdcat cute "\"Then... {w=0.5}couldn't you just help me?\" "
    lpdcat cute ""
...
translate german day2_03_lpdcat_7cecd102:
    ...
    # lpdcat serious "\"Even I— I mean Yan Shu-Chi, never considered dancing as a real career option. {w=0.5}Do you think you could really manage that?\" "
    lpdcat serious ""
...
translate german day2_03_lpdcat_924ab2e3:
    ...
    # avt "\"It's not like my other options are any better anyway... {w=0.5}I don't really care for that stuffy religious stuff.\" "
    avt ""
...
translate german day2_03_lpdcat_b455a989:
    ...
    # lpdcat serious "\"So just... {w=0.5}think about it, all right?\" "
    lpdcat serious ""
...
translate german day2_03_normal_7528614b:
    ...
    # avt "\"How long that would take! {w=0.5}Ten years? I'd need to give up dancing during the best years of my career! There's no way!\" "
    avt ""
...
translate german day2_04_aace2a06:
    ...
    # b "Now everyone's gonna think we're in cahoots or something... {w=0.5}Is every club like this, or maybe it's just ours. "
    b ""
...
translate german day2_04_75679a39:
    ...
    # avt "\"It's all right— {w=0.5}It's just, that... {w=0.5}Well, are you familiar with Rukai traditions?\" "
    avt ""
...
translate german day2_04_d33b7345:
    ...
    # b "Could there really be no clouded leopard gods in the Rukai? {w=0.5}I mean, even with how humble he is about what he knows, he's usually on top of this stuff. "
...
translate german day2_04_edf4049c:
    ...
    # avt "\"I'm fine. It's just... {w=0.5}well honestly, some guys were making fun of me. It just put me off a bit.\" "
    avt ""
...
translate german day2_04_5eaf5a02:
    ...
    # lpdcat normal "\"Okaaay— I'll go easy on you for now. {w=0.5}Actually I was about to go home and grab my stuff. There's nothing else scheduled for the club today so you can go home early too.\" "
    lpdcat normal ""

# game/script/03_day2.rpy:1590
translate german day2_04_08fe74c1:

    # avt "\"Oh... {w=0.5}Yeah... {w=0.5}sounds good.\" "
    avt ""
...
translate german day2_04_d6556212:
    ...
    # b "I open the door to find Senpai lugging a full on travel suitcase down the corridor... {w=0.5}Where is he even going to put this much stuff. "
    b ""

# game/script/03_day2.rpy:1644
translate german day2_04_a8bc0d99:

    # avt "\"Senpai... That bag's huge. {w=0.5}Where are you even going to put it?\" "
    avt ""
...
translate german day2_04_28e87cc0:
    ...
    # avt "\"So he's a yaoguai... {w=0.5}who became a guardian tiger?\" "
    avt ""
...
translate german day2_04_ccce8250:
    ...
    # b "On top of that people are starting to think we're in a relationship... {w=0.5}I feel sorry for when Yan Shu-Chi he has to deal with this. "
    b ""
