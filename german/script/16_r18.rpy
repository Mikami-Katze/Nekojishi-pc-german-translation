...
translate german s16_branch3_r18_01_43bc6dd5:
    ...
    avt "\"Es ist... normalerweise... etwas was man macht, wenn man mit wem eine Beziehung eingeht...\" "
...
translate german s16_branch3_r18_01_13381d32:
    ...
    voice voice_file.tig("16L",1)
    tig lift "\"Wirklich? Aber ich bin ein Gott. Du kannst doch kaum mit einem Gott ein Date haben, oder?\" "
...
translate german s16_branch3_r18_01_59048265:
    ...
    avt "\"Was willst du mir damit sagen? Du musst dafür Verantwortung übernehmen!\" "
...
translate german s16_branch3_r18_01_3b82d4a2:
    ...
    voice voice_file.tig("16L",2)
    tig normal "\"Welche Verantwortung? Das spielt keine Rolle. Ich bleibe dennoch den Rest deines Lebens an deiner Seite.\" "

# game/script/16_r18.rpy:11
translate german s16_branch3_r18_01_f4e1ea70:

    # avt "\"...as a tutelar god to me?\" "
    avt "\"...als Wächter für mich?\" "

# game/script/16_r18.rpy:13
translate german s16_branch3_r18_01_415803e7:
...
translate german s16_branch3_r18_01_cf37016e:
    ...
    avt "\"Selbst wenn wir es nicht getan hätten... selbst wenn ich nie in der Lage war dich zu sehen... würdest du immernoch bei mir bleiben?\" "
...
translate german s16_branch3_r18_01_f82fef6c:
    ...
    voice voice_file.tig("16L",5)
    tig confused "\"...Liao, geht es dir nicht gut?\" "
...
translate german s16_branch3_r18_01_3a0cf6d9:
...
translate german s16_branch3_r18_01_38010e18:
    ...
    avt "\"Du weist was ich {i}meine{/i}. Ich will wissen ob du mich \"magst\". Nicht wie meine Familie. Nicht irgendeine Art des Mögens. Sondern ob du {i}mich{/i} magst... das ist meine Frage...\" "
...
translate german s16_branch3_r18_04_58213ad3:
    ...
    tig laugh_2 "Nachwievor... bin ich der Einzige der es mit dir getan hat.\" "

# game/script/16_r18.rpy:83
translate german s16_branch3_r18_04_51ba0227:

    # avt "\"You make it sound like that's a prerequisite!\" "
    avt "\"Du sprichst es aus, als wäre es eine Grundvoraussetzung!\" "
...
translate german s16_branch3_r18_04_f5b3a736:
    ...
    voice voice_file.tig("16L",8)
    tig normal "\"Nein, ich habe bloß geprahlt.\" "

# game/script/16_r18.rpy:91
translate german s16_branch3_r18_04_2166e7b1:
