...
translate german s12_b7972935:
    ...
    # lpdcat happy "\"Well it means— {w=0.5}that we should go on a date!\" "
    lpdcat happy ""
...
translate german s12_accept_81004c84:
    ...
    # jiahao "\"Liao... {w=0.5}that was your first time, right? You did pretty good.\" "
    jiahao ""
...
translate german s12_accept_6daf5257:
    ...
    # b "And considering he's staring right at at me, I'd hazard a guess they're a member of Shu-chi's fan club. "
    b ""
...
translate german s12_accept_821c84a2:
    ...
    # lpdcat difficult "\"They will...{w=0.5} umm... {w=0.5}degrade to an {font=tl/None/NotoSansCJKtc-Bold.otf}earth spirit{/font}, maybe.\" "
...
translate german s12_accept_21765059:
    ...
    # lpdcat serious "\"I know you wanted to wait until summer break, but that can't happen. I don't expect you to give up your finals just to come with me. So... {w=0.5}It's better we stop here.\" "
    lpdcat serious ""
...
translate german s12_accept_87c350e9:
    ...
    # avt "\"You really have to go so soon? That's so sudden... {w=0.5}Your God of Soil is almost gone. {i}Why{/i} \ did you keep this from me?\" "
    avt ""
...
translate german s12_accept_362f2912:
    ...
    # lpdcat difficult "\"I'm sorry Liao. I know I didn't talk to you before making this decision. But it's not like you being able to come to Mialoi is really your decision anyway.\" "
...
translate german s12_accept_3b20f0de:
    ...
    # avt "\"Senpai...{w=0.5} Do you {i}really{/i} \ think this is a good for either of us?\" "
    avt ""
...
translate german s12_accept_02_comfort_ced35ec0:
    ...
    # avt "\"I-{w=0.2}I can't promise to go to Miali with you... but I can at least do my best to try and make it happen with my family. Even if it's not for long, I could at least help during the summer break... and I could even help on weekends. If that'd be better?\" "
    avt ""
...
translate german s12_accept_02_comfort_c3785181:
    ...
    # lpdcat laugh "\"Maybe that really will work?\" "
    lpdcat laugh ""
...
translate german s12_accept_03_088aee46:
    ...
    # lpdcat wronged "\"Hey... {w=0.5}Liao... it's a bit hard to ask...{w=0.5} but...\" "
    lpdcat wronged ""
...
translate german s12_accept_04_go_0ddb3cdc:
    ...
    # lpdcat serious "\"Well, I can't really promise that. It's not like I'd have Yan Shu-Chi's money at that point. I'd be difficult...\" "
    lpdcat serious ""

# game/script/12.rpy:869
translate german s12_accept_04_go_034b3c48:

    # avt "\"If you can work something out, I might be able to come...\" "
    avt ""
...
translate german s12_accept_04_go_24efd734:
    ...
    # lpdcat laugh "\"Is it because of what I just told you?\" "
    lpdcat laugh ""
...
translate german s12_accept_04_go_1a4a8f63:
    ...
    # lpdcat normal "\"You've always known that I needed you help... but you didn't know what is really meant before now, huh?\" "
    lpdcat normal ""

# game/script/12.rpy:883
translate german s12_accept_04_go_5d9c9a8d:

    # b "Senpai pushes a finger against my lips, silencing my argument. "
    b ""
...
translate german s12_accept_04_go_b127ea0c:
    ...
    # b "Senpai, getting ahead of me, turns a corner. "
    b ""
...
translate german s12_accept_04_dont_go_5feb674c:
    ...
    # avt "\"I don't think I should. Going right now feels... Tiger asked me not to wonder around, sorry...\" "
    avt ""

# game/script/12.rpy:982
translate german s12_accept_04_dont_go_4f9ee32c:

    # lpdcat pout "\"Whaaa— What's that old man got to do with this. And coming to my place isn't wondering around at all~\" "
    lpdcat pout ""
